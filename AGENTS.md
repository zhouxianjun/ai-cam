...
To ensure your implementation aligns with this project's architecture and quality standards, you **MUST** read and follow these four documents:
...
- 🔌 **[ESP32 Hardware Specs (ESP-IDF)](./developer.esp.md)**: C/C++, FreeRTOS scheduler, esp-webrtc-solution, PSRAM frame buffers, and TLS configurations.
...
- 📖 **Local Docs Path**: `nitro-app/node_modules/nitro/dist/docs/README.md`
...
> **Warning for Frontend Pages**: Any non-route files (such as sub-components or local utilities) placed under `nitro-app/app/pages/` **must** be stored inside double-underscores directories (e.g., `nitro-app/app/pages/dashboard/__components__/`) to prevent the file-based router from mapping them to URL paths.
