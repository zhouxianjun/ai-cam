...
- 🔌 **ESP32 Hardware Specs (ESP-IDF)**: [developer.esp.md](./developer.esp.md)
- 🤖 **Agent Guide**: [AGENTS.md](./AGENTS.md)

## Core Development Commands

All core commands must be run within the `nitro-app` directory (or using `pnpm --prefix nitro-app <command>`):

- **Start Dev Server**: `pnpm --prefix nitro-app run dev`
- **Code Formatter**: `pnpm --prefix nitro-app run fmt` (uses oxfmt)
- **Code Linter**: `pnpm --prefix nitro-app run lint` (uses oxlint)
- **Type Check Server**: `pnpm --prefix nitro-app run typecheck:server`
- **Type Check App**: `pnpm --prefix nitro-app run typecheck:app`
- **Check All**: `pnpm --prefix nitro-app run check:all`
- **Build Server/Client**: `pnpm --prefix nitro-app run build`
...
3. **File-Based Routing Route Guard**: Non-route files in `nitro-app/app/pages/` must go in double-underscored subdirectories (e.g. `__components__/`).
